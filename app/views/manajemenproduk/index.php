                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                        Kategori</th>
                      <th class="text-secondary opacity-7" style="width: 120px;"></th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="<?= BASEURL ?>/img/kaos.png" alt="" class="img-fluid max-width-100">
                          </div>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs text-center font-weight-bold" th:text="'Rp. '">10.000</span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">Kaos polo</span>
                      </td>
