  ...
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="<?= BASEURL ?>/manajemenproduk">
            <div
              class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Manajemen Produk</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Manajemen Produk</h6>
        </nav>
      </div>
    </nav>
                  ...
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                        style="width: 350px;">Nama Produk
                      </th>
                      <!-- <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Stock</th> -->
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Harga Start Form
                      </th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                        Deskripsi</th>
                      <th class="text-secondary opacity-7" style="width: 120px;">Aksi</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php foreach( $data['produk'] as $prdk) : ?>
                        ...
                        <td>
                            ...
                            <div>
                                <img src="<?= BASEURL ?>/img/<?= $prdk['gambar']; ?>" alt="" class="img-fluid max-width-100">
                            </div>
                            <div class="d-flex flex-column justify-content-center">
                                <h6 class="mb-0 text-sm"><?= $prdk['nama_produk']; ?></h6>
                            </div>
                            </div>
                        </td>
                        <!-- <td>
                        ...
                        <td class="align-middle text-center">
                            <span class="text-secondary text-xs text-center font-weight-bold" th:text="'Rp. '"><?= $prdk['harga']; ?></span>
                        </td>
                        <td class="align-middle text-center">
