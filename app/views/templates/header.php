...
<head>
  ...
  <link rel="icon" type="image/png" href="<?= BASEURL ?>/img/logo-konveksi.png">
  <title>
    Konveksi Rahayu <?= $data['judul'] ?>
  </title>
  <!--     Fonts and icons     -->
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="<?= BASEURL ?>/css/argon-dashboard.css?v=2.0.4" rel="stylesheet" />
  <!-- cdn -->
